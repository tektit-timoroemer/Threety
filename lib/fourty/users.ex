defmodule Fourty.Users do
  ...
  """
  def has_role?(%User{} = user, :admin), do: user.role == 1
  def has_role?(%User{} = user, :user), do: user.role == 0
  ...
  def change_edit_pw(%EditPW{} = edit_pw, attrs \\ %{}) do
    EditPW.changeset(edit_pw, attrs)
  end
